...
namespace RomSoft.Client.Debug
{
    ...
    using RomSoft.Client.Debug.Controls.Diagrams;
    using RomSoft.Client.Debug.Controls.Diagrams.Interfaces;
    using RomSoft.Client.Debug.Controls.Windows;
    ...
    public sealed class RomSoftClientDebugPackage : Package
    {
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = FindToolWindow(typeof(GenerateWorkflowDiagramWindow), 0, true);
