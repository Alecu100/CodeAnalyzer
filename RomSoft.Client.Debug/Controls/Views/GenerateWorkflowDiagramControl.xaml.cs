...
namespace RomSoft.Client.Debug.Controls.Views
{
    #region Using
    ...
    using RomSoft.Client.Debug.Library.Constants;
    using RomSoft.Client.Debug.Library.Interfaces;
    using RomSoft.Client.Debug.Library.Listeners;
    ...
    public partial class GenerateWorkflowDiagramControl : IVsSolutionEvents, IXamlResourcesRepository
    {
        ...
        {
            var staticWorkflowEvaluator = ObjectFactory.GetInstance<IStaticWorkflowEvaluator>();
