...
namespace RomSoft.Client.Debug.Library.Listeners
{
    #region Using
    ...
    public class WorkflowEvaluatorEvaluatorListener : IStaticWorkflowEvaluatorListener
    {
        ...
        public void AfterVariableDeclared(TrackedVariable variable)
        {
        }
