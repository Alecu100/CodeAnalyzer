...
namespace CodeEvaluator.Demos.Demo4
{
    public class MyClass1
    {
        ...
        {
            WorkflowEvaluator.AddProcess("MethodOverloaded1 Process1", "MethodOverloaded1 Process1", "MethodOverloaded1 Process1");
        ...
        {
            WorkflowEvaluator.AddProcess("MethodOverloaded2 Process1", "MethodOverloaded2 Process1", "MethodOverloaded2 Process1");
